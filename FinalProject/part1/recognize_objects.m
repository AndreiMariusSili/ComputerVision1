function [predicted_labels, accuracy, prob_estimates] = recognize_objects(quant_feats, model, category)
    ...
    [predicted_labels, accuracy, prob_estimates] = predict(label_vector, sparse(instance_matrix), model, "motorbikes");
end